...
image: main license-agg copy-bin buildah-image ;
...
license-agg: ## Aggregate all of the license files used to build the go binary
...
.PHONY: deploy build test linux image clean push deploy-helm deploy-openshift create-ns provision bind license-agg help
