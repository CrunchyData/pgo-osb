...
Latest Release: v4.5.2, 2021-03-08
...
instance, if you are using **pgo-osb** v4.5.2, please ensure the Crunchy
PostgreSQL Operator v4.5.2 is also deployed in your environment.
