...
Latest Release: v4.3.3, 2020-09-10
...
instance, if you are using **pgo-osb** v4.3.3, please ensure the Crunchy
PostgreSQL Operator v4.3.3 is also deployed in your environment.
