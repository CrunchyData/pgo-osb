...
Latest Release: v4.7.1, 2021-08-12
...
instance, if you are using **pgo-osb** v4.7.1, please ensure the Crunchy
PostgreSQL Operator v4.7.1 is also deployed in your environment.
